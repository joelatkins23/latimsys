...
$from=$_POST['from'];
$to=$_POST['to'];
$supplier_bill_consignee_id=$_POST['supplier_bill_consignee_id'];
$serach_text="";
if($supplier_bill_consignee_id!=''){
    $serach_text.=" and a.supplier_id = '$supplier_bill_consignee_id' or a.bill_id = '$supplier_bill_consignee_id' or a.consignee_id = '$supplier_bill_consignee_id' ";
}
## Search 
$searchQuery = " ";
if($searchValue != ''){
