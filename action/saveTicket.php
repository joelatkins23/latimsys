...
$queryModel = mysqli_query($connect, "INSERT INTO tickets(type, service, name, supplier, supplier_phone, supplier_address, tracking_number, warehouse_receipt, notes, imagen1, imagen2, imagen3, status, fecha, agent_id) 
