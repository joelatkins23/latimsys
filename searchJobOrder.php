                ...
                <div class="searchPage shadow2" style="background:white; width:90%; margin-left:-45%;">
                    ...
                    <div class="row" style="margin-top:20px;">
                        <form action="#" id="filter">
                            ...
                            <div class="col-md-2">
                                <div class=" input-group">
                                    <input type="text" class="form-control" data-provide="datepicker" id="to" data-date-format="yyyy-mm-dd" laceholder="To" value="" autocomplete="off"  placeholder="To">
                                </div>
                            </div>
                            <div class="col-md-2">
