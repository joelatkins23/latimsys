...
<head>
    ...
    <title>Latim Cargo & Trading | Search Pending Bills</title>
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Search Pending Bills</li>
                </ol>
            </section>
                    ...
                    <div class="col-md-offset-1 col-md-10 shadow2" style="background: white;margin-top:50px">
                        <div class="row" >
                            <div class="col-md-12 text-center" style="border-bottom:1px solid #555555; padding-bottom:10px;">                   
                                <h3  class="text-center" style="text-align:center; color:black; font-weight:800; font-size:20px;    margin-top: 30px; ">Search Pending Bills</h3>                          
                            </div>
                        </div> 
    ...
    <script>
        ...
        $("#invoice_menu #search_pending_bills").addClass("active");
