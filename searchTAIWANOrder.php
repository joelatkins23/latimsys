...
<body class="hold-transition sidebar-mini">
    ...
    <script>
        ...
        $("#taiwanorders_list").addClass("active");
        $("#taiwanorders_list #search").addClass("active");
        ...
        $(".download_excel").on("click", function(e){
            window.open("./excel/excel_job_taiwan.php?from="+from+"&to="+to);
        })
    </script>
</body>
